(function () {
  var prices = {
    intimate: {
      name: "The Intimate (50 Bottles)",
      10: { 4: [8500, 170], 6: [9500, 190] },
      30: { 4: [12500, 250], 6: [13500, 270] }
    },
    celebration: {
      name: "The Celebration (100 Bottles)",
      10: { 4: [13500, 135], 6: [14500, 145] },
      30: { 4: [19500, 195], 6: [20500, 205] }
    },
    grand: {
      name: "The Grand (150 Bottles)",
      10: { 4: [18500, 123], 6: [19500, 130] },
      30: { 4: [27500, 183], 6: [28500, 190] }
    }
  };
  ...
  document.querySelectorAll('[data-scents]').forEach(function (btn) {
    btn.addEventListener('click', function () {
      document.querySelectorAll('[data-scents]').forEach(function (b) {
        b.classList.remove('active');
      });
      btn.classList.add('active');
  ...
  function updatePreview() {
    ...
    heroNames.textContent = n === "Your Names" ? "Gabby & Katie" : n;
